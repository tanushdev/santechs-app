            ...
            <DropdownMenuContent align="end" className="w-56 p-2 space-y-1">
              ...
              <DropdownMenuItem
                onClick={async () => {
                  ...
                  window.location.href = isAdmin ? "/super_admin" : isSeller ? "/login?role=seller" : "/";
                }}
                className="cursor-pointer text-xs text-red-600 focus:text-red-600 focus:bg-red-50 flex items-center gap-2 p-2 font-semibold"
              >
