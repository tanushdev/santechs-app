...
const categories = [
  {
    ...
    icon: Settings,
    label: "Machines",
    description: "Synthetic filament, Non-woven, DTY, ATY, and plastic extrusion lines.",
    href: "/products?type=MACHINE",
    count: "Machines Directory",
    subcategories: ["Non-Woven", "Filament Spinning", "DTY & ATY", "Extrusion"],
  },
  {
    id: "spare-parts",
    icon: Wrench,
    label: "Spare Parts",
    description: "Hot godet rollers, spinnerets, metering pumps, spin packs, and dryers.",
    href: "/products?type=SPARE_PART",
    count: "Spare Parts",
    subcategories: ["Godet Rollers", "Spinnerets", "Metering Pumps", "CPF Filters"],
  },
  {
    id: "raw-materials",
    icon: Leaf,
    label: "Raw Materials",
    description: "Polyester chips, flakes, polypropylene, and recycled polymers.",
    href: "/products?type=RAW_MATERIAL",
    count: "Raw Materials",
    subcategories: ["PET Chips", "Polyester", "Polypropylene", "Recycled Flakes"],
  },
  {
    id: "services",
    icon: Briefcase,
    label: "Services",
    description: "Machinery erection, dismantling, commissioning, and relocation support.",
    href: "/products?type=SERVICE",
    count: "Specialized Services",
    subcategories: ["Installation", "Commissioning", "Relocation", "Inspection"],
  },
];
